...
fun main(args: Array<String>) {
    val des = DES().encrypt("АРКАДЬЕВ", "ДМИТРИЕВ")
    val gost = GOST().encrypt("АРКАДЬЕВ", "ОРТОхлорбензилиденмалонодинитрил")
    ...
    val DiSi = DigitalSignature(19.toBigInteger(), 13.toBigInteger(), 2.toBigInteger())
